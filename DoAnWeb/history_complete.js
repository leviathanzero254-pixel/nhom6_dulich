/* 
==============================================================================
FILE: history_complete.js
TÁC VỤ CHÍNH:
  • Hiển thị lịch sử tất cả các vé đã đặt (tương tự history.js)
  • Quản lý chức năng hủy vé
  • Quản lý chức năng xóa tất cả lịch sử
  • Cập nhật trạng thái thanh toán của vé (bản đầy đủ)
  • Kiểm tra trạng thái đăng nhập
  • Xử lý đăng xuất
  • Hiển thị danh sách vé theo thứ tự mới nhất trước
  • LƯU Ý: File này có vẻ là một bản sao hoặc phiên bản khác của history.js
==============================================================================
*/
...
// Xử lý đăng xuất
document.getElementById("nut-dang-xuat-history").addEventListener("click", () => {
    ...
    danhSachVe.reverse().forEach((ve, index) => {
        ...
        veDiv.innerHTML = `
            ...
            <div class="hang-nut-hanh-dong">
                <button class="nut-thanh-toan" onclick="capNhatThanhToan(${danhSachVe.length - index - 1})">💳 ${ve.trangThaiThanhToan === "Đã thanh toán" ? "Chưa Thanh Toán" : "Đã Thanh Toán"}</button>
